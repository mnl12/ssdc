...
class CUB200(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, root, input_size, crop_size, train=True, transform=None, p_transform=None, iaa_aug=False, resize=256):
        """
        Load the dataset.
    ...
    def __getitem__(self, index):
        ...
        if self._train:
            if self._p_transform is not None:
                return image, image_p, target, cls_name, img_name
            else:
